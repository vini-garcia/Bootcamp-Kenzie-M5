...
class MovieOrderModelTest(TestCase):
    def test_bought_at_properties(self):
        result = MovieOrder._meta.get_field("bought_at").auto_now_add
        msg = f"Verifique se a propriedade `auto_now_add` de `bought_at` foi definida"
